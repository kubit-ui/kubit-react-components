...
import {
  compile
} from "./chunk-EWMXQ7LI.js";
import "./chunk-TZFMPTC2.js";
import "./chunk-5HVX6DW4.js";
import {
  __commonJS,
  __toESM
} from "./chunk-OALZARQH.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-76X5TKO7.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-HLBIUWRR.js")).default;
  return {
