import CJS_COMPAT_NODE_URL_lxz9dpi7zdp from 'node:url';
import CJS_COMPAT_NODE_PATH_lxz9dpi7zdp from 'node:path';
import CJS_COMPAT_NODE_MODULE_lxz9dpi7zdp from "node:module";

var __filename = CJS_COMPAT_NODE_URL_lxz9dpi7zdp.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_lxz9dpi7zdp.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_lxz9dpi7zdp.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-OALZARQH.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-76X5TKO7.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-HLBIUWRR.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-DVFR2SX6.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
