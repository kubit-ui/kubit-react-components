...
export function createFlattenedArgs(context) {
...
function flattenObjectRecursively(nestedObject, pathToParent, context) {
    ...
    Object.entries(nestedObject).forEach(([key, value]) => {
        ...
        const shouldFlatten = isPojo(value) && !context.userDefinedArgTypes[key] && Object.keys(value).length;
        if (!shouldFlatten) {
...
export function createFlattenedArgTypes(context) {
...
export function expandObject(flatObject) {
    if (!flatObject) {
