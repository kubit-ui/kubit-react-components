...
declare const Collapsible: (({ children, summary, collapsed, disabled, initialCollapsed, storageKey, state: providedState, ...props }: {
...
declare const useCollapsible: ({ collapsed, disabled, initialCollapsed, storageKey, }: {
    collapsed?: boolean;
    disabled?: boolean;
    initialCollapsed?: boolean;
    storageKey?: string;
