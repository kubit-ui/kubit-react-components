	...
	function output(type, msg, options$1 = {}) {
		if (thresh >= LogLevels[type]) {
			...
			if (canClearScreen) if (type === lastType && msg === lastMsg) {
				sameCount++;
				clear();
				console[method](format(type, msg, options$1), import_picocolors.default.yellow(`(x${sameCount + 1})`));
			} else {
				sameCount = 0;
				lastMsg = msg;
				lastType = type;
				if (options$1.clear) clear();
				console[method](format(type, msg, options$1));
			}
			else console[method](format(type, msg, options$1));
		}
	}
