...
import { SelectVariantType } from './variants';

type SelectVariant = keyof typeof SelectVariantType;

export const SELECT: SelectVariantStyles<SelectVariant> = {
