export default {'kubit':{  ACCORDION: {
  ...
  RADIO_BUTTON: {
    ...
    tooltip: {
      maincontent: 'tooltip__maincontent--regular',
      arrowelement: 'tooltip__arrowelement--regular',
      popover: 'tooltip__popover',
      overlay: 'tooltip__overlay',
      hoverbridgecontainer: 'tooltip__hoverbridgecontainer',
    },
  },
  SELECT: {
    select: 'select',
  ...
  TOOLTIP: {
    ...
    hoverbridgecontainer: 'tooltip__hoverbridgecontainer',
    $_regular: {
      tooltip: 'tooltip--regular',
      maincontent: 'tooltip__maincontent tooltip__maincontent--regular',
      arrowelement: 'tooltip__arrowelement tooltip__arrowelement--regular',
    },
    maincontent: 'tooltip__maincontent',
    arrowelement: 'tooltip__arrowelement',
  },
  VIRTUAL_KEYBOARD: {
