...
import { DataTableSimpleVerticalAlignStory } from './dataTable.simple.verticalAlign';
...
export const DataTableSimpleVerticalAlign: Story = {
  args: DataTableSimpleVerticalAlignStory,
};
