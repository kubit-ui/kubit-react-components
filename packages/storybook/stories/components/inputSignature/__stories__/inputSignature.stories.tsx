...
import type { InputSignatureCustomHandle } from '../types/inputSignature';

import { InputSignatureUnControlled } from '../inputSignatureUncontrolled';
import { argtypes } from './argTypes';

const meta = {
  argTypes: argtypes(),
  component: InputSignatureUnControlled,
  parameters: {
    githubUrl:
...
} satisfies Meta<typeof InputSignatureUnControlled>;
