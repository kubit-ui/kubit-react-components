...
export const TableWithStickyLeftRightColumns: StoryType = {
  args: {
    ...commonArgs,
    additionalClasses: {
...
>
  <TableHead variant="DEFAULT">
    <TableRow hoverable={false} variant="HEADER_ROW_DEFAULT">
      ...
      <TableCell sticky="right" th={true} variant="HEADER_CELL_DEFAULT">Header Cell 4</TableCell>
    </TableRow>
  </TableHead>
  <TableBody variant="DEFAULT">
    <TableRow variant="BODY_ROW_DEFAULT">
      ...
      <TableCell variant="BODY_CELL_DEFAULT">Row 1 - Cell 2</TableCell>
      <TableCell variant="BODY_CELL_DEFAULT">Row 1 - Cell 3</TableCell>
      <TableCell sticky="right" variant="BODY_CELL_DEFAULT">Row 1 - Cell 4</TableCell>
    </TableRow>
  </TableBody>
</Table>`,
      },
