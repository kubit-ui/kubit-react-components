// types
export type {
  ModalTitleTextType as ModalTitleTextTypeV2,
  ModalButtonType as ModalButtonTypeV2,
  ModalFooterType as ModalFooterTypeV2,
  ModalPopoverType as ModalPopoverTypeV2,
  IModalStyled as IModalStyledV2,
  IModalStandAlone as IModalStandAloneV2,
  IModalControlled as IModalControlledV2,
