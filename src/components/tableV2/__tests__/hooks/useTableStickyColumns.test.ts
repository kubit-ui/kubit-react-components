...
import { useTableStickyColumns } from '../../hooks/useTableStickyColumns';
...
describe('useTableStickyColumns', () => {
  ...
  it('should do nothing when disabled is true', () => {
    renderHook(() => useTableStickyColumns({ ref, disabled: true }));
  ...
  it('should do nothing when there is not scrollable container', () => {
    ...
    renderHook(() => useTableStickyColumns({ ref: wrapperWithoutScrollableContainer }));
    expect(tableCell.style.right).toBe('');
  });
  ...
  it('When there is horizontal scroll, right style for sticky columns should be set', () => {
    ...
    renderHook(() => useTableStickyColumns({ ref }));
